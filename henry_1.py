...
def TaskExe():
    ...
    def whatsapp():
        ...
        if 'poojan' or 'pujan' in name:
            ...
            min=int(takecommand())
            pywhatkit.sendwhatmsg("+916352557653",msg,hour,min,10)
            ...
            speak("time in minutes!")
            min=int(takecommand())
            pywhatkit.sendwhatmsg("+919426461601",msg,hour,min,10)
            speak("ok sir , sending whatsapp message!")
    ...
    def chromeauto():
        ...
        elif 'history' or 'story' in command:
